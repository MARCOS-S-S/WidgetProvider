...
class SpotifyWidgetLargeProvider : AppWidgetProvider() {
    ...
    private fun updateAppWidgetWithSavedSettings(
        ...
        val views = SpotifyWidgetProvider.createLargeWidget(context, widgetStyle, transparency)
    ...
    override fun onEnabled(context: Context) {
        // Quando o primeiro widget grande é criado
    }

    override fun onDisabled(context: Context) {
        // Quando o último widget grande é removido
    }
}
