...
class SpotifyWidgetSmallProvider : AppWidgetProvider() {
    ...
    private fun updateAppWidgetWithSavedSettings(
        ...
        val views = SpotifyWidgetProvider.createSmallWidget(context, widgetStyle, transparency)
    ...
    override fun onEnabled(context: Context) {
        // Quando o primeiro widget pequeno é criado
    }

    override fun onDisabled(context: Context) {
        // Quando o último widget pequeno é removido
    }
}
